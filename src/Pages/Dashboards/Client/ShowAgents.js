  ...
  const assignAgent = async (agentId) => {
    try {
      ...
      const assignResponse = await axios.put(
        `http://localhost:8081/api/client/requests/${requestId}/assign?agentId=${agentId}`,
        null,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
      ...
      window.location.href = "http://localhost:3000/client/requests/all";
    } catch (error) {
